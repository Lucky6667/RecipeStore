...
function RecipeStore.getOption(name)
    ...
    -- Defaults
    if name == "AllowAllItems" or name == "RandomMode" then return false end
    return 0
end -- <--- This was commented out in your original code
...
local function onEveryOneMinute()
    local player = getSpecificPlayer(0) -- Safer for SP than getPlayer()
